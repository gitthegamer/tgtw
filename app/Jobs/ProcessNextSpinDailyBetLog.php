...
class ProcessNextSpinDailyBetLog implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $start_date = $date->copy()->startOfDay()->setTimezone(new \DateTimeZone('-04:00'))->format('Y-m-d\TH:i:sP');
        $end_date = $date->copy()->endOfDay()->setTimezone(new \DateTimeZone('-04:00'))->format('Y-m-d\TH:i:sP');
