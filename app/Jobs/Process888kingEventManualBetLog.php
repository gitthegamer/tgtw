...
class Process888kingEventManualBetLog implements ShouldQueue
{
    ...
    {
        $result = _Event_888king::getManualBets();
        ...
        Cache::put('888king_bets_status', now());
    }
