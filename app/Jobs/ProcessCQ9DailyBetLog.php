...
class ProcessCQ9DailyBetLog implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $endtime = $date->copy()->endOfDay()->setTimezone(new \DateTimeZone('-04:00'))->format('Y-m-d\TH:i:sP');
        $starttime = $date->copy()->startOfDay()->setTimezone(new \DateTimeZone('-04:00'))->format('Y-m-d\TH:i:sP');
