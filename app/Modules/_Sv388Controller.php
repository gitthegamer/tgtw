...
class _Sv388Controller
{
    ...
    {
        $controller = new _Sv388Controller();
    ...
    {
        if (
            $function == "/fetch/getSummaryByTxTimeHour" ||
            ...
            return config('api.SV388_REPORT_LINK') . $function;
        }
        return config('api.SV388_LINK') . $function;
    }
    ...
    public function request($function, $params)
    {
        ...
        $method = "POST";
        $logForDB = [
            'channel' => ModelsLog::CHANNEL_SV388,
            'function' => $function,
