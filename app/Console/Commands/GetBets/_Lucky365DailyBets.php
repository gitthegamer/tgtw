...
class _Lucky365DailyBets extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get_bets:_Lucky365DailyBets {date?}';
    ...
    public function handle()
    {
        ...
        $startDate = $date->copy()->subHours(2)->format('Y-m-d H:i:s');
        echo $startDate . " - " . $endDate . "\n";
        echo "lucky365 max bet time: 2 hours\n";
