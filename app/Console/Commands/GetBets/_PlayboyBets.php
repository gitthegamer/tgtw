...
class _PlayboyBets extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get_bets:_PlayboyBets';
    ...
    public function process($betTickets)
    {
        if ($betTickets && count($betTickets) > 0) {
            ...
            $ticket = rtrim($ticket, ', ');
            if ($ticket != '') {
                $response = _PlayboyController::init("markbyjson.aspx", [
