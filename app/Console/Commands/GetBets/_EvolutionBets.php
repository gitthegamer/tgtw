...
class _EvolutionBets extends Command
{
    // SexyBaccarat
    /**
     ...
     * @var string
     */
    protected $signature = 'get_bets:_EvolutionBets {date?}';
    ...
    public function handle()
    {
        ...
        $startDate = $date->copy()->subHour()->setTimezone('UTC')->format('Y-m-d\TH:i:s\Z'); 
        $endDate = $date->copy()->setTimezone('UTC')->format('Y-m-d\TH:i:s\Z');
