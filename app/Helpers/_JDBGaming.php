...
use App\Modules\_JDBGamingController;
...
class _JDBGaming
{
    public static function create(Member $member)
    {
        ...
        $response = _JDBGamingController::init("wallet/createMember", [
    ...
    {
        $response = _JDBGamingController::init("wallet/getBalance", [
            'cert' => config('api.AWC_CERT'),
            'agentId' => config('api.AWC_USER_ID'),
            "alluser" => 0,
    ...
    {
        $response = _JDBGamingController::init("wallet/deposit", [
            'cert' => config('api.AWC_CERT'),
            'agentId' => config('api.AWC_USER_ID'),
    ...
    {
        $response = _JDBGamingController::init("wallet/withdraw", [
            'cert' => config('api.AWC_CERT'),
            'agentId' => config('api.AWC_USER_ID'),
            'userId' => $member_account->username,
            'txCode' => $transfer->uuid,
    ...
    public static function checkTransaction($uuid)
    {
        ...
        $response = _JDBGamingController::init("wallet/checkTransferOperation", [
            'cert' => config('api.AWC_CERT'),
            'agentId' => config('api.AWC_USER_ID'),
            'txCode' => $transfer->uuid,
        ]);
    ...
    public static function launch(Member $member, $gameid = null, $isMobile = false, $blimit = null)
    {
        ...
        $response = _JDBGamingController::init("wallet/login", [
            'cert' => config('api.AWC_CERT'),
            'agentId' => config('api.AWC_USER_ID'),
            'userId' => $member_account->username,
            ...
            'platform' => 'JDB',
            'gameType' => 'SLOT',
            'gameForbidden' => '{"JILI":{"SLOT":["ALL"]},"PP":{"SLOT":["ALL"],"LIVE":["ALL"]},"SPADE":{"SLOT":["ALL"]},"FC":{"SLOT":["ALL"]}}',
            'language' => _JDBGamingController::getLocale(),
        ]);
